 ...
 * @author NAT
 */
public class NationalityList extends javax.swing.JFrame implements WindowListener{
    ...
    NationalitiesBLL bll = new NationalitiesBLL();
    ...
    private void initComponents() {
        ...
        tbNationalities = new javax.swing.JTable();
        ...
        tbNationalities.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbNationalities.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbNationalitiesMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbNationalities);
        if (tbNationalities.getColumnModel().getColumnCount() > 0) {
            tbNationalities.getColumnModel().getColumn(1).setPreferredWidth(200);
        }
    ...
    private void btNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNewActionPerformed
        ...
        int row = tbNationalities.getRowCount();
        Nationality frame= new Nationality(row,"New");
        frame.setVisible(true);
    }//GEN-LAST:event_btNewActionPerformed

    private void tbNationalitiesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbNationalitiesMouseClicked
        // TODO add your handling code here:
        int row = tbNationalities.getSelectedRow();
        id = Integer.valueOf(tbNationalities.getModel().getValueAt(row, 0).toString());
        btEdit.setEnabled(true);
        btDelete.setEnabled(true);
    }//GEN-LAST:event_tbNationalitiesMouseClicked

    private void btEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditActionPerformed
        // TODO add your handling code here:
        Nationality frame = new Nationality(id,"Edit");
        frame.setVisible(true);
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Xác nhận xóa ?", "WARNING", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            int row = tbNationalities.getSelectedRow();
            id = Integer.valueOf(tbNationalities.getModel().getValueAt(row, 0).toString());
            bll.deleteNationalitiesDAL(id);
            model = (DefaultTableModel) tbNationalities.getModel();
            model.removeRow(row);
        }
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    public void loadData(){
        int row = 0;
        DefaultTableModel model = (DefaultTableModel) tbNationalities.getModel();
        List list = bll.readNationalitiesBll();
        for (Iterator iterator = list.iterator(); iterator.hasNext();) {
            Nationalities cert = (Nationalities) iterator.next();
            model.addRow(new Object[0]);
            model.setValueAt(cert.getId(), row, 0);
            model.setValueAt(cert.getNationalityName(), row, 1);
            row++;
        } 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NationalityList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tbNationalities;
