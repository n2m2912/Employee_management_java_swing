 ...
 * @author NAT
 */
public class ReligionList extends javax.swing.JFrame implements WindowListener{
    ...
    ReligionBLL bll = new ReligionBLL();
    ...
    private void initComponents() {
        ...
        tbReligion = new javax.swing.JTable();
        ...
        tbReligion.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbReligion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbReligionMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbReligion);
        if (tbReligion.getColumnModel().getColumnCount() > 0) {
            tbReligion.getColumnModel().getColumn(1).setPreferredWidth(200);
        }
    ...
    private void btNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNewActionPerformed
        ...
        int row = tbReligion.getRowCount();
        Religion frame= new Religion(row,"New");
        frame.setVisible(true);
    }//GEN-LAST:event_btNewActionPerformed

    private void tbReligionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbReligionMouseClicked
        // TODO add your handling code here:
        int row = tbReligion.getSelectedRow();
        id = Integer.valueOf(tbReligion.getModel().getValueAt(row, 0).toString());
        btEdit.setEnabled(true);
        btDelete.setEnabled(true);
    }//GEN-LAST:event_tbReligionMouseClicked

    private void btEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditActionPerformed
        // TODO add your handling code here:
        Religion frame = new Religion(id,"Edit");
        frame.setVisible(true);
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Xác nhận xóa ?", "WARNING", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            int row = tbReligion.getSelectedRow();
            id = Integer.valueOf(tbReligion.getModel().getValueAt(row, 0).toString());
            bll.deleteReligionsDAL(id);
            model = (DefaultTableModel) tbReligion.getModel();
            model.removeRow(row);
        }
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    public void loadData(){
        int row = 0;
        DefaultTableModel model = (DefaultTableModel) tbReligion.getModel();
        List list = bll.readReligionsBll();
        for (Iterator iterator = list.iterator(); iterator.hasNext();) {
            Religions cert = (Religions) iterator.next();
            model.addRow(new Object[0]);
            model.setValueAt(cert.getId(), row, 0);
            model.setValueAt(cert.getReligionName(), row, 1);
            row++;
        } 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReligionList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tbReligion;
