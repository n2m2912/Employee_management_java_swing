 ...
 * @author NAT
 */
public class ProvinceList extends javax.swing.JFrame implements WindowListener{
    ...
    private void initComponents() {
        ...
        tbProvince = new javax.swing.JTable();
        ...
        tbProvince.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbProvince.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbProvinceMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbProvince);
        if (tbProvince.getColumnModel().getColumnCount() > 0) {
            tbProvince.getColumnModel().getColumn(1).setPreferredWidth(200);
        }
    ...
    private void btNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNewActionPerformed
        ...
        int row = tbProvince.getRowCount();
        Province frame= new Province(row,"New");
        frame.setVisible(true);
    }//GEN-LAST:event_btNewActionPerformed

    private void tbProvinceMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbProvinceMouseClicked
        // TODO add your handling code here:
        int row = tbProvince.getSelectedRow();
        id = Integer.valueOf(tbProvince.getModel().getValueAt(row, 0).toString());
        btEdit.setEnabled(true);
        btDelete.setEnabled(true);
    }//GEN-LAST:event_tbProvinceMouseClicked

    private void btEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditActionPerformed
        // TODO add your handling code here:
        Province frame = new Province(id,"Edit");
        frame.setVisible(true);
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Xác nhận xóa ?", "WARNING", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            int row = tbProvince.getSelectedRow();
            id = Integer.valueOf(tbProvince.getModel().getValueAt(row, 0).toString());
            bll.deleteProvincesDAL(id);
            model = (DefaultTableModel) tbProvince.getModel();
            model.removeRow(row);
        }
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    public void loadData(){
        int row = 0;
        DefaultTableModel model = (DefaultTableModel) tbProvince.getModel();
        List list = bll.readProvincesBll();
        for (Iterator iterator = list.iterator(); iterator.hasNext();) {
            Provinces cert = (Provinces) iterator.next();
            model.addRow(new Object[0]);
            model.setValueAt(cert.getId(), row, 0);
            model.setValueAt(cert.getProvinceName(), row, 1);
            row++;
        } 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProvinceList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tbProvince;
