 ...
 * @author NAT
 */
public class FolkList extends javax.swing.JFrame implements WindowListener{
    ...
    private void initComponents() {
        ...
        tbFolks.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbFolksMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbFolks);
        if (tbFolks.getColumnModel().getColumnCount() > 0) {
    ...
    private void btNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNewActionPerformed
        ...
        int row = tbFolks.getRowCount();
        Folk frame= new Folk(row,"New");
        frame.setVisible(true);
    }//GEN-LAST:event_btNewActionPerformed

    private void tbFolksMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbFolksMouseClicked
        // TODO add your handling code here:
        int row = tbFolks.getSelectedRow();
        id = Integer.valueOf(tbFolks.getModel().getValueAt(row, 0).toString());
        btEdit.setEnabled(true);
        btDelete.setEnabled(true);
    }//GEN-LAST:event_tbFolksMouseClicked

    private void btEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditActionPerformed
        // TODO add your handling code here:
        Folk frame = new Folk(id,"Edit");
        frame.setVisible(true);
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Xác nhận xóa ?", "WARNING", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            int row = tbFolks.getSelectedRow();
            id = Integer.valueOf(tbFolks.getModel().getValueAt(row, 0).toString());
            bll.deleteFolksDAL(id);
            model = (DefaultTableModel) tbFolks.getModel();
            model.removeRow(row);
        }
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    public void loadData(){
        int row = 0;
        DefaultTableModel model = (DefaultTableModel) tbFolks.getModel();
        List list = bll.readFolksBll();
        for (Iterator iterator = list.iterator(); iterator.hasNext();) {
            Folks cert = (Folks) iterator.next();
            model.addRow(new Object[0]);
            model.setValueAt(cert.getId(), row, 0);
            model.setValueAt(cert.getFolkName(), row, 1);
            row++;
        } 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FolkList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tbFolks;
