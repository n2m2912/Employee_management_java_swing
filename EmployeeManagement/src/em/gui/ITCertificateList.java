...
import em.bll.ITCertificateBLL;
 ...
 * @author NAT
 */
public class ITCertificateList extends javax.swing.JFrame implements WindowListener{

    public static JButton btE;
    public static JTable tb ;
    String btName="";
    ItCertificates itCert;
    int id ;
    DefaultTableModel model;
    ITCertificateBLL bll = new ITCertificateBLL();
    /** Creates new form EmployeeList */
    public ITCertificateList() {
        initComponents();
        setInfoDialog();
        loadData();
    ...
    private void initComponents() {
        ...
        tbITCertificate = new javax.swing.JTable();
        ...
        tbITCertificate.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbITCertificate.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbITCertificateMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbITCertificate);
        if (tbITCertificate.getColumnModel().getColumnCount() > 0) {
            tbITCertificate.getColumnModel().getColumn(1).setPreferredWidth(200);
        }
    ...
    private void btNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNewActionPerformed
        ...
        int row = tbITCertificate.getRowCount();
        ITCertificate frame= new ITCertificate(row,"New");
        frame.setVisible(true);
    }//GEN-LAST:event_btNewActionPerformed

    private void tbITCertificateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbITCertificateMouseClicked
        // TODO add your handling code here:
        int row = tbITCertificate.getSelectedRow();
        id = Integer.valueOf(tbITCertificate.getModel().getValueAt(row, 0).toString());
        btEdit.setEnabled(true);
        btDelete.setEnabled(true);
    }//GEN-LAST:event_tbITCertificateMouseClicked

    private void btEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditActionPerformed
        // TODO add your handling code here:
        ITCertificate frame = new ITCertificate(id,"Edit");
        frame.setVisible(true);
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Xác nhận xóa ?", "WARNING", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            int row = tbITCertificate.getSelectedRow();
            id = Integer.valueOf(tbITCertificate.getModel().getValueAt(row, 0).toString());
            bll.deleteItCertificatesDAL(id);
            model = (DefaultTableModel) tbITCertificate.getModel();
            model.removeRow(row);
        }
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    public void loadData(){
        int row = 0;
        DefaultTableModel model = (DefaultTableModel) tbITCertificate.getModel();
        List list = bll.readItCertificatesBll();
        for (Iterator iterator = list.iterator(); iterator.hasNext();) {
            ItCertificates cert = (ItCertificates) iterator.next();
            model.addRow(new Object[0]);
            model.setValueAt(cert.getId(), row, 0);
            model.setValueAt(cert.getITName(), row, 1);
            row++;
        } 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ITCertificateList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tbITCertificate;
