 ...
 * @author NAT
 */
public class JobList extends javax.swing.JFrame implements WindowListener{
    ...
    private void initComponents() {
        ...
        tbJob.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbJobMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbJob);
        if (tbJob.getColumnModel().getColumnCount() > 0) {
            tbJob.getColumnModel().getColumn(1).setPreferredWidth(200);
        }
    ...
    private void btNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNewActionPerformed
        ...
        int row = tbJob.getRowCount();
        Job frame= new Job(row,"New");
        frame.setVisible(true);
    }//GEN-LAST:event_btNewActionPerformed

    private void tbJobMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbJobMouseClicked
        // TODO add your handling code here:
        int row = tbJob.getSelectedRow();
        id = Integer.valueOf(tbJob.getModel().getValueAt(row, 0).toString());
        btEdit.setEnabled(true);
        btDelete.setEnabled(true);
    }//GEN-LAST:event_tbJobMouseClicked

    private void btEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditActionPerformed
        // TODO add your handling code here:
        Job frame = new Job(id,"Edit");
        frame.setVisible(true);
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Xác nhận xóa ?", "WARNING", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            int row = tbJob.getSelectedRow();
            id = Integer.valueOf(tbJob.getModel().getValueAt(row, 0).toString());
            bll.deleteJobsDAL(id);
            model = (DefaultTableModel) tbJob.getModel();
            model.removeRow(row);
        }
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    public void loadData(){
        int row = 0;
        DefaultTableModel model = (DefaultTableModel) tbJob.getModel();
        List list = bll.readJobsBll();
        for (Iterator iterator = list.iterator(); iterator.hasNext();) {
            Jobs cert = (Jobs) iterator.next();
            model.addRow(new Object[0]);
            model.setValueAt(cert.getId(), row, 0);
            model.setValueAt(cert.getJobName(), row, 1);
            row++;
        } 
    }
