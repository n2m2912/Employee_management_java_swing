 ...
 * @author NAT
 */
public class PositionList extends javax.swing.JFrame implements WindowListener{
    ...
    private void initComponents() {
        ...
        if (tbPosition.getColumnModel().getColumnCount() > 0) {
            tbPosition.getColumnModel().getColumn(1).setPreferredWidth(200);
        }
    ...
    private void btNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNewActionPerformed
        ...
        int row = tbPosition.getRowCount();
        Position frame= new Position(row,"New");
    ...
    private void tbPositionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbPositionMouseClicked
        ...
        int row = tbPosition.getSelectedRow();
        id = Integer.valueOf(tbPosition.getModel().getValueAt(row, 0).toString());
    ...
    private void btEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditActionPerformed
        // TODO add your handling code here:
        Position frame = new Position(id,"Edit");
        frame.setVisible(true);
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Xác nhận xóa ?", "WARNING", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            int row = tbPosition.getSelectedRow();
            id = Integer.valueOf(tbPosition.getModel().getValueAt(row, 0).toString());
            bll.deletePositionsDAL(id);
            model = (DefaultTableModel) tbPosition.getModel();
            model.removeRow(row);
        }
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    public void loadData(){
        int row = 0;
        DefaultTableModel model = (DefaultTableModel) tbPosition.getModel();
        List list = bll.readPositionsBll();
        for (Iterator iterator = list.iterator(); iterator.hasNext();) {
            Positions cert = (Positions) iterator.next();
            model.addRow(new Object[0]);
            model.setValueAt(cert.getId(), row, 0);
            model.setValueAt(cert.getPositionName(), row, 1);
            row++;
        } 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PositionList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
