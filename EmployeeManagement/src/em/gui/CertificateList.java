 ...
 * @author NAT
 */
public class CertificateList extends javax.swing.JFrame implements WindowListener{
    ...
    CertificatesBLL bll = new CertificatesBLL();
    ...
    private void initComponents() {
        ...
        if (tbCertificates.getColumnModel().getColumnCount() > 0) {
    ...
    private void btNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNewActionPerformed
        ...
        int row = tbCertificates.getRowCount();
        Certificate frame= new Certificate(row,"New");
    ...
    private void tbCertificatesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbCertificatesMouseClicked
        ...
        id = Integer.valueOf(tbCertificates.getModel().getValueAt(row, 0).toString());
    ...
    private void btEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditActionPerformed
        // TODO add your handling code here:
        Certificate frame = new Certificate(id,"Edit");
        frame.setVisible(true);
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Xác nhận xóa ?", "WARNING", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            int row = tbCertificates.getSelectedRow();
            id = Integer.valueOf(tbCertificates.getModel().getValueAt(row, 0).toString());
            bll.deleteCertificatesDAL(id);
            model = (DefaultTableModel) tbCertificates.getModel();
            model.removeRow(row);
        }
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    public void loadData(){
        int row = 0;
        DefaultTableModel model = (DefaultTableModel) tbCertificates.getModel();
        List list = bll.readCertificateBll();
        for (Iterator iterator = list.iterator(); iterator.hasNext();) {
            Certificates cert = (Certificates) iterator.next();
            model.addRow(new Object[0]);
            model.setValueAt(cert.getId(), row, 0);
            model.setValueAt(cert.getCertificateName(), row, 1);
            row++;
        } 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CertificateList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
