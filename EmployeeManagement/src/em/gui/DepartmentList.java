 ...
 * @author NAT
 */
public class DepartmentList extends javax.swing.JFrame implements WindowListener{

    public static JButton btE;
    public static JTable tbDe ;
    String btName="";
    Departments departs;
    int id ;
    ...
    private void initComponents() {
        ...
        tbDepartments.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbDepartmentsMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbDepartments);
        if (tbDepartments.getColumnModel().getColumnCount() > 0) {
            tbDepartments.getColumnModel().getColumn(1).setPreferredWidth(200);
        }
    ...
    private void btNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNewActionPerformed
        int row = tbDepartments.getRowCount();
        int id = Integer.valueOf(tbDepartments.getModel().getValueAt(tbDepartments.getRowCount()-1, 0).toString());
        Department deGui= new Department(id,"New");
        deGui.setVisible(true);
    }//GEN-LAST:event_btNewActionPerformed

    private void tbDepartmentsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDepartmentsMouseClicked
        // TODO add your handling code here:
        int row = tbDepartments.getSelectedRow();
        id = Integer.valueOf(tbDepartments.getModel().getValueAt(row, 0).toString());
        btEdit.setEnabled(true);
        btDelete.setEnabled(true);
    }//GEN-LAST:event_tbDepartmentsMouseClicked

    private void btEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditActionPerformed
        // TODO add your handling code here:
        Department derpFrame = new Department(id,"Edit");
        derpFrame.setVisible(true);
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Xác nhận xóa ?", "WARNING", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            int row = tbDepartments.getSelectedRow();
            id = Integer.valueOf(tbDepartments.getModel().getValueAt(row, 0).toString());
            bll.deleteDepartmentsDAL(id);
            model = (DefaultTableModel) tbDepartments.getModel();
            model.removeRow(row);
        }
        btEdit.setEnabled(false);
        btDelete.setEnabled(false);
    ...
    public void loadData(){
        ...
        List emps = bll.readDepartmentBll();
        for (Iterator iterator = emps.iterator(); iterator.hasNext();) {
            Departments depart = (Departments) iterator.next();
            model.addRow(new Object[0]);
            model.setValueAt(depart.getId(), row, 0);
            model.setValueAt(depart.getDepartmentName(), row, 1);
            row++;
        } 
    }
